...
export default function SeatSelection() {
  ...
  const calculateTotal = () => {
    return selectedSeats.reduce((total, seatId) => {
      ...
      const price = isVipSeat(rowIndex) ? seatLayout.vipPrice : seatLayout.regularPrice
      return total + price
    }, 0)
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">Choose your preferred seats for the event</p>
          </div>
        </div>
                ...
                <div className="space-y-4">
                          ...
                          {Array.from({ length: seatLayout.seatsPerRow }, (_, seatIndex) => {
                            ...
                            return (
                              <button
                                ...
                                `}
                                title={`Seat ${seatId} - ${vip ? "VIP" : "Regular"} - $${vip ? seatLayout.vipPrice : seatLayout.regularPrice}`}
                              >
                                {seatIndex + 1}
                              </button>
                            )
                  ...
                  <div className="flex justify-center gap-6 mt-6 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Available Regular (${seatLayout.regularPrice})</span>
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <Card className="bg-white dark:bg-gray-800 sticky top-4">
              ...
              <CardContent className="space-y-4">
                {selectedSeats.length === 0 ? (
                  <p className="text-gray-500 dark:text-gray-400 text-center py-4">No seats selected</p>
                ) : (
                  <>
                        ...
                        {selectedSeats.map((seatId) => {
                          ...
                          return (
                            <Badge
                              ...
                              className={vip ? "bg-yellow-500 text-yellow-900" : ""}
                            >
                              {seatId} {vip ? "(VIP)" : ""}
                            </Badge>
                          )
